...
class SearchTermItem(QFrame):
    ...
    def _edit_term(self):
        # Implementação de edição: abrir um QInputDialog para editar
        # Por simplicidade, faremos apenas uma simulação
        print(f"Editar termo: {self.term}")
        # A lógica completa exigiria um QInputDialog e atualização do estado global

    def _exclude_term(self):
        # A lógica de exclusão deve ser delegada à janela principal para atualizar o estado
        if self.parent_window and hasattr(self.parent_window, 'remove_search_term'):
            self.parent_window.remove_search_term(self.term)
        self.deleteLater() # Remove o widget da tela
...
class ConfigWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        # Inicia a tela com os termos da configuração padrão
    ...
    def _setup_content(self):
        ...
        # Simulando um seletor de data (poderia ser um QCalendarWidget)
    ...
    def add_search_term(self):
        """Adiciona um novo termo de busca à lista."""
